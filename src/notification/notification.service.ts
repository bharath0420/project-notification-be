...
export class NotificationService {
  ...
  sendNotification(notificationPayload: any): Observable<any> {
    const fcmUrl = 'https://fcm.googleapis.com/fcm/send';
    const fcmKey = 'AAAA5mjXNko:APA91bEKllNemurRce6sxdOwNlIJ5lZgdRxTrkGOsmkUPgm_-V-FRzPoAiZ-VDnQklmrOsa4UH8--EbilYxJnPgBLi2PwiOJ_lQE5un_-D_RNvcxjQDz8dVS7mHToHypWnFKYvYXROC2'; // Replace with your FCM server key
    ...
    return this.httpService.post(fcmUrl, notificationPayload, { headers });
  }
}